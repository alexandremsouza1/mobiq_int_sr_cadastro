...
class PixItauAdapter implements AdapterInterface
{
    ...
    public function __construct(Factory $factory)
    {
      ...
      $this->factory->boot(Factory::$PIX);
      $this->chave = config("itau_payments_keys.pix.chave");
    }

    public function getAdapt($data): array
    {
        $pixAdaptIntegration = $this->adaptIntegrationPix($data);
        $resultPixAdaptIntegration = $this->factory->build($pixAdaptIntegration);
